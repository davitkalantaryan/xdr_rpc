 ...
 *	u_long vers;
 */
MINI_XDR_EXPORT void	svc_unregister __P((u_long __prog, u_long __vers));
 ...
 *	SVCXPRT *xprt;
 */
MINI_XDR_EXPORT void	xprt_register __P((SVCXPRT *__xprt));
 ...
 *	SVCXPRT *xprt;
 */
MINI_XDR_EXPORT void	xprt_unregister __P((SVCXPRT *__xprt));
 ...
 */
MINI_XDR_EXPORT void svc_getreq __P((int __rdfds));
MINI_XDR_EXPORT void svc_getreqset __P((fd_set *__readfds));
MINI_XDR_EXPORT void svc_exit __P((void));
MINI_XDR_EXPORT void svc_run __P((void));
 ...
 */
MINI_XDR_EXPORT SVCXPRT *svcraw_create __P((void));
